		...
		<div class="w-full md:max-w-4xl mx-auto flex flex-wrap items-center justify-between mt-0 py-3">
			...
			<div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-gray-100 md:bg-transparent z-20" id="nav-content">
				<ul class="list-reset lg:flex justify-end flex-1 items-center">
					<li class="mr-3">
						<a class="inline-block py-2 px-4 text-gray-900 font-bold no-underline" href="#">Journal</a>
					</li>
					<li class="mr-3">
						<a class="inline-block text-gray-600 no-underline hover:text-gray-900 hover:text-underline py-2 px-4" href="#">Project</a>
					</li>
					<li class="mr-3">
	...
	<div class="container w-full md:max-w-3xl mx-auto pt-20">
		...
		<div class="flex w-full items-center font-sans px-4 py-12">
			...
			<div class="flex-1 px-2">
				<p class="text-base font-bold text-base md:text-xl leading-none mb-2">Irfannur Diah</p>
				<p class="text-gray-600 text-xs md:text-base">Orang Dalam DiBalik Studio <a class="text-green-500 no-underline hover:underline" href="#">Ruèma</a></p>
			</div>
